module.exports = function () {
    ...
    return {
        ...
        find(flag, params = {}) {
            ...
            if (!flag) {
                new Exception("Must have a flag: 'active', 'new', 'staff', 'suspended', 'blocked', 'suspect'");
            }
        ...
        updateAvatar(username, params = {}) {
            return self
                .put(`/users/${username}/preferences/pick`, { ...params })
        },

        updateEmail(username, email) {
            return self
                .put(`/users/${username}/preferences/email`, { email });
        },

        create(name, email, password, username, active, approved) {
            const params = {
                name,
                email,
                password,
